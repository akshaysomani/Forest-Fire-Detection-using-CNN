...
class GISEventService:
    async def publish_geofence_breach(self, geofence_id: str, geofence_name: str, latitude: float, longitude: float) -> None:
        ...
        payload = {"geofence_id": geofence_id, "geofence_name": geofence_name, "latitude": latitude, "longitude": longitude}
