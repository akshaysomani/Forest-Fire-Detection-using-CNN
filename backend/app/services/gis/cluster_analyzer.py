...
class ClusterAnalyzer:
    async def find_detection_clusters(
        self, db: AsyncSession, distance_threshold_meters: float = 1000.0
    ) -> List[Dict[str, Any]]:
        """
        ...
        for d in detections:
            ...
            for candidate in detections:
                ...
                dist = boundary_engine.haversine_distance(d.latitude, d.longitude, candidate.latitude, candidate.longitude)
