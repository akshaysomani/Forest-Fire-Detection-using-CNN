    ...
    def compare_versions(version_a: ModelVersion, version_b: ModelVersion) -> Dict[str, Any]:
        ...
        for key in all_metric_keys:
            ...
            if isinstance(val_a, (int, float)) and isinstance(val_b, (int, float)):
                metrics_diff[key] = {"value_a": val_a, "value_b": val_b, "difference": val_b - val_a}
            elif val_a is not None or val_b is not None:
                metrics_diff[key] = {"value_a": val_a, "value_b": val_b, "difference": "non-numeric-comparison"}
        ...
        for key in all_hp_keys:
            ...
            val_b = hp_b.get(key)
            if val_a != val_b:
                hp_diff[key] = {"value_a": val_a, "value_b": val_b, "changed": True}
            else:
                hp_diff[key] = {"value_a": val_a, "value_b": val_b, "changed": False}

        return {"metrics_diff": metrics_diff, "hyperparameters_diff": hp_diff}
