...
async def get_overview(db: AsyncSession = Depends(get_db), current_user: User = Depends(get_current_active_user)):
    """
...
async def get_recent_activity(
    ...
    return {"activities": activity_items, "total_count": total_count}
