...
# --- Secure S3 Bucket for Model Registry Artifacts ---
...
# IAM Policy to let ECS task write/read to model registry S3 bucket
resource "aws_iam_policy" "s3_access" {
  name        = "${var.project_name}-s3-access-${var.environment}"
  description = "Allows read and write access to model registry bucket"
...
resource "aws_security_group" "ecs_tasks" {
  ...
  description = "Access to task containers only through the ALB"
  vpc_id      = aws_vpc.main.id
